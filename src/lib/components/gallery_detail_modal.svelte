<script lang="ts">
	...
	import GalleryDetailModalAlertBar from './gallery_detail_modal/gallery_detail_modal_alert_bar.svelte';
	import GalleryDetailModalHeader from './gallery_detail_modal/gallery_detail_modal_header.svelte';
	import GalleryDetailModalHeaderActions from './gallery_detail_modal/gallery_detail_modal_header_actions.svelte';
	import GalleryDetailModalMetaActions from './gallery_detail_modal/gallery_detail_modal_meta_actions.svelte';
	import GalleryDetailModalMetaPanel from './gallery_detail_modal/gallery_detail_modal_meta_panel.svelte';
	import GalleryDetailModalMetaReadList from './gallery_detail_modal/gallery_detail_modal_meta_read_list.svelte';
